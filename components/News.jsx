...
export default function News() {
  ...
  return (
    <section id="news" className="py-16 bg-gradient-to-r from-pink-50 via-white to-pink-50">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {news.map((item, idx) => (
            <motion.div
              key={idx}
              className="bg-white/90 backdrop-blur-sm rounded-xl shadow-md overflow-hidden hover:shadow-xl transition"
